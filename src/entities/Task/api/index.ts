...
export async function create(name: string, token: string): Promise<MangosResponse<Task>> {
	try {
...
export async function update(id: number, name: string, token: string): Promise<MangosResponse<Task>> {
	try {
